...
Temps: manual unit is °C/°F x1/x10 per DIP SW2-P7/P8. Model assumes x10
(P7 ON) -> s16/factor 10; °C (P8 OFF). NOTE the manual's DIP default is x1
(P7 OFF): at factory DIP setting temps read 10x low through this model.
...
DATA = [
    ...
    (161, "Zone 1: Temperature: Setpoint", "main zone setpoint; §8.2.4", "°C", "s16", 10, "R/W", "0", "0", 3),
    (162, "Zone 1: Setpoint: Custom Lower Limit: Heat", "§8.2.4", "°C", "s16", 10, "R/W", "0", "0", 3),
    (163, "Zone 1: Setpoint: Custom Upper Limit: Heat", "§8.2.4", "°C", "s16", 10, "R/W", "0", "0", 3),
    (164, "Zone 1: Setpoint: Custom Lower Limit: Cool", "§8.2.4", "°C", "s16", 10, "R/W", "0", "0", 3),
    (165, "Zone 1: Setpoint: Custom Upper Limit: Cool", "§8.2.4", "°C", "s16", 10, "R/W", "0", "0", 3),
    (166, "Zone 1: Setpoint: Unit Lower Limit: Heat", "absolute unit limit; §8.2.4", "°C", "s16", 10, "R", "0", "0", 3),
    (167, "Zone 1: Setpoint: Unit Upper Limit: Heat", "absolute unit limit; §8.2.4", "°C", "s16", 10, "R", "0", "0", 3),
    (168, "Zone 1: Setpoint: Unit Lower Limit: Cool", "absolute unit limit; §8.2.4", "°C", "s16", 10, "R", "0", "0", 3),
    (169, "Zone 1: Setpoint: Unit Upper Limit: Cool", "absolute unit limit; §8.2.4", "°C", "s16", 10, "R", "0", "0", 3),
    (170, "Zone 1: Setpoint: Applied Lower Limit: Heat", "currently applied; §8.2.4", "°C", "s16", 10, "R", "0", "0", 3),
    (171, "Zone 1: Setpoint: Applied Upper Limit: Heat", "currently applied; §8.2.4", "°C", "s16", 10, "R", "0", "0", 3),
    (172, "Zone 1: Setpoint: Applied Lower Limit: Cool", "currently applied; §8.2.4", "°C", "s16", 10, "R", "0", "0", 3),
    (173, "Zone 1: Setpoint: Applied Upper Limit: Cool", "currently applied; §8.2.4", "°C", "s16", 10, "R", "0", "0", 3),
    (191, "Zone 1: Scheduled Mode", "0 off 1 on; §8.2.4", "", "u16", 1, "R/W", "0", "1", 3),
    # 8.2.5 room registers
    (201, "Room 1: Temperature: Setpoint", "room setpoint (manual p37 cites PLC 161, typo); §8.2.5", "°C", "s16", 10, "R/W", "0", "0", 3),
    (202, "Room 1: Setpoint: Custom Lower Limit: Heat", "§8.2.5", "°C", "s16", 10, "R/W", "0", "0", 3),
    (203, "Room 1: Setpoint: Custom Upper Limit: Heat", "§8.2.5", "°C", "s16", 10, "R/W", "0", "0", 3),
    (204, "Room 1: Setpoint: Custom Lower Limit: Cool", "§8.2.5", "°C", "s16", 10, "R/W", "0", "0", 3),
    (205, "Room 1: Setpoint: Custom Upper Limit: Cool", "§8.2.5", "°C", "s16", 10, "R/W", "0", "0", 3),
    (206, "Room 1: Setpoint: Unit Lower Limit: Heat", "absolute unit limit; §8.2.5", "°C", "s16", 10, "R", "0", "0", 3),
    (207, "Room 1: Setpoint: Unit Upper Limit: Heat", "absolute unit limit; §8.2.5", "°C", "s16", 10, "R", "0", "0", 3),
    (208, "Room 1: Setpoint: Unit Lower Limit: Cool", "absolute unit limit; §8.2.5", "°C", "s16", 10, "R", "0", "0", 3),
    (209, "Room 1: Setpoint: Unit Upper Limit: Cool", "absolute unit limit; §8.2.5", "°C", "s16", 10, "R", "0", "0", 3),
    (210, "Room 1: Setpoint: Applied Lower Limit: Heat", "currently applied; §8.2.5", "°C", "s16", 10, "R", "0", "0", 3),
    (211, "Room 1: Setpoint: Applied Upper Limit: Heat", "currently applied; §8.2.5", "°C", "s16", 10, "R", "0", "0", 3),
    (212, "Room 1: Setpoint: Applied Lower Limit: Cool", "currently applied; §8.2.5", "°C", "s16", 10, "R", "0", "0", 3),
    (213, "Room 1: Setpoint: Applied Upper Limit: Cool", "currently applied; §8.2.5", "°C", "s16", 10, "R", "0", "0", 3),
    (215, "Room 1: Temperature: Modbus Room Thermostat Ambient Reference", "BMS thermistor write, activates virtual temp; §8.2.5", "°C", "s16", 10, "R/W", "0", "0", 3),
    (217, "Room 1: Antifrost Mode", "0 off 1 on; §8.2.5", "", "u16", 1, "R", "0", "1", 3),
    (218, "Room 1: Antifrost Room Setpoint Temperature: Heat", "§8.2.5", "°C", "s16", 10, "R", "0", "0", 3),
    ...
    (277, "DHW: Temperature: Setpoint", "DHW setpoint; §8.2.6", "°C", "s16", 10, "R/W", "0", "0", 3),
    (278, "DHW: Setpoint: Custom Lower Limit", "§8.2.6", "°C", "s16", 10, "R/W", "0", "0", 3),
    (279, "DHW: Setpoint: Custom Upper Limit", "§8.2.6", "°C", "s16", 10, "R/W", "0", "0", 3),
    (280, "DHW: Setpoint: Tank Lower Limit", "absolute tank limit; §8.2.6", "°C", "s16", 10, "R", "0", "0", 3),
    (281, "DHW: Setpoint: Tank Upper Limit", "absolute tank limit; §8.2.6", "°C", "s16", 10, "R", "0", "0", 3),
    (282, "DHW: Setpoint: Applied Lower Limit", "currently applied; §8.2.6", "°C", "s16", 10, "R", "0", "0", 3),
    (283, "DHW: Setpoint: Applied Upper Limit", "currently applied; §8.2.6", "°C", "s16", 10, "R", "0", "0", 3),
    (286, "DHW: Temperature: Tank Reference", "tank thermistor(s); §8.2.6", "°C", "s16", 10, "R", "0", "0", 3),
    ...
    (305, "Temperature: A2W Unit Outdoor Ambient Reference", "outdoor ambient; §8.2.7", "°C", "s16", 10, "R", "0", "0", 3),
    (306, "Temperature: Refrigerant Reference", "outdoor refrigerant; §8.2.7", "°C", "s16", 10, "R", "0", "0", 3),
    (307, "Temperature: Outlet Water Reference", "leaving-water temp; §8.2.7", "°C", "s16", 10, "R", "0", "0", 3),
    (308, "Temperature: Outlet Water Reference (Plate Heat Exchanger)", "PHE inlet from outdoor; §8.2.7", "°C", "s16", 10, "R", "0", "0", 3),
    (309, "Temperature: Inlet Water Reference", "inlet backup heater water; §8.2.7", "°C", "s16", 10, "R", "0", "0", 3),
